...
public class NumeroToLetras {
    ...
    private final String[] DECENAS = {"diez ", "once ", "doce ", "trece ", "catorce ",
                                       ...
                                       "dieciocho ", "diecinueve", "veinte ", "treinta ", 
    ...
    public String Convertir(String numero, boolean mayusculas, int mon) {
        String literal = "";
        ...
        if (Pattern.matches("\\d{1,9},\\d{1,2}", numero)) {
            ...
            String valor = "";
            // validar que si es MN no ponga valor decimal
            if(moneda > 1){
                valor = literal + " con " + parte_decimal;
            } else {
                valor = literal;
            }
